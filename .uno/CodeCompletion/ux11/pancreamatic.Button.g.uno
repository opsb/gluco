namespace pancreamatic
{
    ...
    public partial class Button: Fuse.Controls.Panel
    {
        ...
        void InitializeUX()
        {
            var temp = new pancreamatic.Text();
            temp_Value_inst = new pancreamatic_FuseControlsTextControl_Value_Property(temp, __selector0);
            this_Text_inst = new pancreamatic_pancreamaticButton_Text_Property(this, __selector1);
            temp_FontSize_inst = new pancreamatic_FuseControlsTextControl_FontSize_Property(temp, __selector2);
            this_FontSize_inst = new pancreamatic_pancreamaticButton_FontSize_Property(this, __selector2);
            var temp1 = new Fuse.Controls.Rectangle();
            var temp2 = new Fuse.Effects.DropShadow();
            var temp3 = new Fuse.Reactive.ReadPropertyBinding(temp_Value_inst, this_Text_inst);
            var temp4 = new Fuse.Reactive.ReadPropertyBinding(temp_FontSize_inst, this_FontSize_inst);
